...
pixi add reproc reproc-cpp reproc-cpp-static reproc-static
# for installing globally
pixi global install reproc reproc-cpp reproc-cpp-static reproc-static
```
...
It is possible to list all of the versions of `reproc` available on your platform:
...
```
pixi search reproc --channel conda-forge
```
